  ...
  return (
    ...
    >
      <BrainIcon
        ...
        className="aui-reasoning-trigger-icon size-4 shrink-0 text-primary/80"
      />
      <span
        data-slot="reasoning-trigger-label"
        className="aui-reasoning-trigger-label-wrapper relative inline-block leading-none group-hover/trigger:text-primary transition-colors"
      >
